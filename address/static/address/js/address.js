(function () {
    ...
    function attachAutocomplete(self) {
        ...
        autocomplete.addListener('place_changed', function () {
            ...
            for (var x = 0; x < place.address_components.length; x++) {
                ...
                if (cmp.types[0] === "sublocality_level_1") {
                    cmp.types[0] = "locality"
                }
    ...
    function init() {
        ...
        for (var i = 0; i < address_inputs.length; i++) {
            attachAutocomplete(address_inputs[i]);
        }
    }
    ...
    window.initAddressAutoComplete = on_ready(init);
})();
